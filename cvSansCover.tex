...
\begin{resume}
\vspace{0.1in}
%\moveleft.5\sectionwidth\centerline{Objective: Computer Science graduate looking for career opportunities in a reputed organization.}  


\section{Education}
\vspace{0.1in} 
 
    Trinity College, Dublin, B.A.(Mod), MCS.\\ 
    Computer Science, 2008 - Present\\
    
    Graduated B.A.(Mod) with I.I\\
...
\vspace{0.1in}
    ...
    The focus of the internship shifted very quickly. Once I had shown what I was capable of I was no longer really regarded as an intern. The work and responsibility entrusted to me changed accordingly. 
...
{\bf Programming} 
       \begin{itemize}
        \item[] Very good level of experience programming in C/C++, Java and Python.\\
